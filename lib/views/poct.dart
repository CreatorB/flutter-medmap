...
class PoCT extends StatefulWidget {
  static const String route = '/poct';
  PoCT({
    Key? key,
  }) : super(key: key);
  @override
...
class _MyState extends State<PoCT> {
  ...
  final List<Map<String, dynamic>> itemCategories = [
    {
      'image': 'assets/icons/ic_cardio.png',
      'title': 'Cardiovascular PoCT',
      'color': Color(0xFFF6EFC6),
      'id': '1390',
    },
    {
      'image': 'assets/icons/ic_cardio.png',
      'title': 'Urogenital PoCT',
      'color': Color(0xFFFCEEE1),
      'id': '1391',
    },
    {
      'image': 'assets/icons/ic_cardio.png',
      'title': 'Critical Care PoCT',
